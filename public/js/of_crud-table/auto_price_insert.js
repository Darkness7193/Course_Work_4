...
function auto_price_insert(product_select) {
    ...
    if (purchase_price_input) { purchase_price_input.value = selected_option.dataset.purchasePrice }
    if (sale_price_input) { sale_price_input.value = selected_option.dataset.salePrice }
}
